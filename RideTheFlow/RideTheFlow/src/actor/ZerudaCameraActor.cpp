...
ZerudaCameraActor::ZerudaCameraActor(IWorld& world) :Actor(world),
...
ZerudaCameraActor::~ZerudaCameraActor()
{

}
void ZerudaCameraActor::Update()
{
	world.EachActor(ACTOR_ID::PLAYER_ACTOR, [&](const Actor& other){
		playerMat = other.GetParameter().mat;
	});
...
void ZerudaCameraActor::Draw() const
{
...
void ZerudaCameraActor::OnCollide(Actor& other, CollisionParameter colpara)
{
