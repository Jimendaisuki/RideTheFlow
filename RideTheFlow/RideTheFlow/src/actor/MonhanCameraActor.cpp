...
{
	//DrawFormatString(0, 464, GetColor(0, 0, 0), "Shipの数   %d", world.GetActorCount(ACTOR_ID::SHIP_ENEMY_ACTOR, ACTOR_ID::SHIP_ENEMY_ACTOR));
	DrawFormatString(0, 432, GetColor(0, 0, 0), "Varistorの数   %d", world.GetActorCount(ACTOR_ID::ENEMY_BULLET, ACTOR_ID::VARISTOR_BULLET_ACTOR));
	DrawFormatString(0, 400, GetColor(0, 0, 0), "Cabnnonの数   %d", world.GetActorCount(ACTOR_ID::ENEMY_BULLET, ACTOR_ID::CANNON_BULLET_ACTOR));
	DrawFormatString(0, 368, GetColor(0, 0, 0), "矢の数   %d", world.GetActorCount(ACTOR_ID::ENEMY_BULLET, ACTOR_ID::ARROW_BULLET_ACTOR));
	DrawFormatString(0, 464, GetColor(0, 0, 0), "Shipの数   %d", world.GetActorCount(ACTOR_ID::ENEMY_ACTOR, ACTOR_ID::ARMY_ENEMY_ACTOR));
	...
	DrawFormatString(0, 128, GetColor(255, 255, 255), "軍隊の数:%d",world.GetActorCount(ACTOR_ID::ENEMY_ACTOR,ACTOR_ID::ARMY_ENEMY_ACTOR));
}
