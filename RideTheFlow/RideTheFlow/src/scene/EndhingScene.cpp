...
void EndhingScene::Initialize()
{
	...
	wa.Add(ACTOR_ID::ENEMY_ACTOR, std::make_shared<CannonEnemy>(wa,Vector3(10,-50,20)));
	wa.Add(ACTOR_ID::ENEMY_ACTOR, std::make_shared<VaristorEnemy>(wa, Vector3(40, -50, 30)));
